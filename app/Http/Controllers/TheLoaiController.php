    ...
    public function store(Request $request)
    {
        $data = $request -> validate(
            ...
            [
                ...
                'tentheloai.unique' => 'Ten the loai da ton tai',
                'slug_theloai.unique' => 'Slug the loai da ton tai',
                'slug_theloai.required' => 'Slug the loai phai co',
                'mota.required' => 'Mo ta the loai phai co',
            ]
           ...
           // dd($data);
            ...
            $theloai ->save();
            return redirect()->back()->with('status','Theem the loai thanh cong');
    }
